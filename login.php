        ...
        <div class="w-full max-w-md p-6 bg-white rounded-md shadow-md" style="margin-top: -100px;">
            ...
            <form action="fungsiLogin.php" method="POST">
                <div class="mb-4 relative">
                    ...
                    <img src="./asset/Vector (1).png" class="absolute right-3 top-0 bottom-0 mt-3  cursor-pointer " width="20 " height="10">
                </div>
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <img src="./asset/Union.png" class=" absolute right-3 top-0 bottom-0 mt-4  cursor-pointer" onclick="togglePasswordVisibility()" width="20 " height="10">
                    </div>
                </div>
